...
export const KENYAN_TOWNS: Record<string, string[]> = {
  Nairobi: ["CBD", "Westlands", "Kilimani", "Eastleigh", "Karen", "Upperhill", "Industrial Area", "Ngong Road", "Kasarani", "South C"],
  Mombasa: ["Nyali", "CBD", "Mtwapa", "Bamburi", "Likoni", "Diani"],
  Kisumu: ["Milimani", "CBD", "Kondele", "Mega City Area", "Kisian"],
  Nakuru: ["CBD", "Section 58", "Milimani", "Njoro", "Freehold"],
  Kiambu: ["Thika", "Ruiru", "Kikuyu", "Kiambu Town", "Juja", "Limuru"],
  "Uasin Gishu (Eldoret)": ["CBD", "Elgon View", "Pioneer", "Kapsoya"],
  Machakos: ["Machakos Town", "Syokimau", "Athi River", "Mlolongo"],
  Nyeri: ["CBD", "King'ong'o", "Skuta", "Naro Moru"],
  Meru: ["CBD", "Makutano", "Nkubu"],
  Kakamega: ["CBD", "Amalemba", "Milimani"],
};
...
export const PRICING_PLANS = [
  {
    id: "free",
    name: "FREE",
    badge: "For New Starters",
    monthlyPrice: 0,
    yearlyPrice: 0,
    description: "Essential presence for emerging Kenyan entrepreneurs stepping into digital commerce.",
    features: [
      "Public business directory profile",
      "Up to 10 product/service listings",
      "Basic sales analytics",
      "Direct WhatsApp customer inquiries",
      "Standard marketplace search listing",
      "VendLex community badge"
    ],
