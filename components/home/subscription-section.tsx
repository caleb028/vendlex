...
export function SubscriptionSection() {
  ...
  return (
    <section className="py-20 bg-white dark:bg-brand-dark-card border-t border-border/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 space-y-3">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-foreground tracking-tight">
            Plans Built to Scale Your Hustle
          </h2>
          <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            No hidden commissions on marketplace sales. Pick a plan that fits your current volume and upgrade anytime.
          </p>
              ...
              <div
                ...
                className={`relative rounded-3xl p-6 sm:p-7 flex flex-col justify-between transition-all duration-300 ${
                  isPopular
                    ...
                    : "bg-brand-off-white dark:bg-brand-dark-bg/60 border border-border dark:border-brand-dark-border text-foreground hover:shadow-card-hover"
                }`}
              >
                {/* Popular Badge */}
                {isPopular && (
                  ...
                  <Link
                    ...
                    className={`w-full py-3.5 px-4 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 transition-all shadow-sm ${
                      isPopular
                        ...
                        : "bg-white dark:bg-brand-dark-card border border-border dark:border-brand-dark-border hover:bg-muted text-foreground"
                    }`}
                  >
