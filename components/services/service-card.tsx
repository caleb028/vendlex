...
export function ServiceCard({ service }: { service: Service }) {
  ...
  return (
    <>
      <div className="group bg-white dark:bg-brand-dark-card border border-border dark:border-brand-dark-border rounded-3xl overflow-hidden shadow-sm hover:shadow-card-hover hover:border-brand-emerald/50 card-elevated flex flex-col justify-between transition-all duration-300">
        <div>
          {/* Cover Photo */}
          ...
          <div className="p-4 sm:p-5 space-y-3">
            <div>
              <div className="flex items-center justify-between text-[11px] text-muted-foreground mb-1">
                ...
                <div className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/60 px-2 py-0.5 rounded-md">
                  ⚡ Response ~15m
                </div>
              </div>
            ...
            <div className="flex items-center justify-between text-xs py-2 border-y border-border/60 dark:border-brand-dark-border/60">
        ...
        <div className="p-4 sm:p-5 pt-0 space-y-2">
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="w-full bg-brand-emerald hover:bg-brand-emerald-dark text-white font-black py-2.5 px-3 rounded-xl text-xs flex items-center justify-center gap-1.5 shadow-sm transition-all btn-glow-emerald"
            >
            ...
            <button
              ...
              className="w-full bg-muted/70 hover:bg-muted text-foreground border border-border font-bold py-2.5 px-3 rounded-xl text-xs flex items-center justify-center gap-1.5 transition-all"
            >
          ...
          <a
            href={`https://wa.me/254700000000?text=Hello%20${encodeURIComponent(service.providerName)},%20I%20found%20your%20services%20on%20VendLex%20and%20need%20assistance%20with%20${encodeURIComponent(service.title)}.`}
            target="_blank"
            rel="noopener noreferrer"
            className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-2 rounded-xl text-[11px] flex items-center justify-center gap-1.5 transition-colors shadow-sm"
          >
