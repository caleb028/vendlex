  ...
  const stats = [
    {
      ...
      change: totalSales > 0 ? "From live customer orders" : "No orders yet",
    ...
    },
    {
      ...
      change: totalOrdersCount > 0 ? `${totalOrdersCount} processed` : "0 orders",
    ...
    },
    {
      ...
      change: uniqueCustomersCount > 0 ? `${uniqueCustomersCount} unique buyers` : "0 buyers",
      isPositive: uniqueCustomersCount > 0,
      icon: Users,
    },
    {
      label: "Products",
      value: totalProductsCount.toString(),
      change: `${totalProductsCount} live in catalog`,
      isPositive: true,
      icon: Package,
    },
  ];
