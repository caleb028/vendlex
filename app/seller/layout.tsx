      ...
      <div className="lg:hidden bg-white dark:bg-brand-dark-card border-b border-border p-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-950/40 hover:bg-red-100 transition-colors"
      ...
      >
        ...
        <div className="pt-4 border-t border-border/80 text-[11px] text-muted-foreground space-y-2">
          ...
          <button
            onClick={handleSignOut}
            disabled={isLoggingOut}
            className="w-full flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl text-xs font-bold text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-950/40 hover:bg-red-100 dark:hover:bg-red-950/70 border border-red-200 dark:border-red-900/50 transition-colors"
          >
            <LogOut className="w-4 h-4" />
